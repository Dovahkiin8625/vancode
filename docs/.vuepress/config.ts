    ...
    nav: [
      { text: "首页", link: "/" },
      {
        ...
        items: [
          ...
          {
            text: "素材",
            items: [{ text: "素材", link: "/frontend/resource/" }],
          },
        ],
      },
      ...
      { text: "大数据", link: "/empty/" },
      {
        ...
        items: [
          {
            text: "微服务与云原生", link: "/microservices/",
            items: [
              { text: "容器化", link: "/microservices/container" },
              { text: "服务发现注册", link: "/microservices/register" },
      ...
      },
      {
        ...
        items: [
          {
            text: "关系库",
            items: [{ text: "MySQL", link: "/db/mysql/" }],
          },
          {
            text: "时序库",
            items: [
        ...
        items: [
          {
            ...
            items: [
              ...
              { text: "运维", link: "/develop/maintenance/" },
              { text: "网络", link: "/develop/network/" },
            ],
          },
          {
            text: "物联网",
            items: [{ text: "物联网", link: "/iot/" }],
          },
  ...
  head: [
    ...
    [
      "meta",
      {
        name: "keywords",
        content:
          "vancode,前端,后端,算法,机器学习,web框架,技术文档,时间序列,深度学习,JavaScript,js,ES6,TypeScript,vue,python,css3,html5,Node,git,github,docker,java,spring,ssm",
      },
    ],
